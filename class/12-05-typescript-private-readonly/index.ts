...
//     // this.mypower = mypower; //public, private, readonly 등 1개만 포함되면 자동으로 세팅됨
//   }
//   ggg() {
...
// console.log(aaaa.mypower); // 외부에서 접근 가능
// aaaa.mypower = 10;// 외부에서 수정 가능
//
//
//
//
...
//   }
//   const aaaa = new Aaa2(50);
//   console.log(aaaa.mypower); // 외부에서 접근 불가
//   aaaa.mypower = 10;// 외부에서 수정 불가
//
//
//
//
